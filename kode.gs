...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & teks utama menggunakan Merah Maroon (#800020) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #800020}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#800020;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#800020;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#800020;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone maroon muda lembut (#FDF6F7) */
    '.info-box{background:#FDF6F7;border:1px solid #E8C8CE;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Merah Maroon (#800020) */
    '.paket-box{background:#800020;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan */
    '.syarat-box{background:#FFFAFA;border:1px solid #F3DBE0;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa soft maroon (#F9ECEE) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#F9ECEE;border:1px solid #DFB0B8;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#600018;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #E8C8CE;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
